<?php
    ...
    // On regarde si il y a bien un id
    if(isset($_GET['id'])){
         $id = $_GET["id"];
    }
...
<html>
  <head>
    <title>McSoupex-View Item-Admin</title>
    <!--Icon-->
  ...
  <h1 class="textLogo">
      ...
      <div class="container admin">
          <div class="row">
              ...
              <div class="col-sm-6">
                <h1><b>Observation de l'item    </b></h1>
                <br/>

                <form>
                    <div class="form-group">
                        <label> Nom : </label><?php echo utf8_encode('   '. $rowItem['name']); ?>
                   </div>

                   <div class="form-group">
                        <label> Description : </label><?php echo utf8_encode('   '. $rowItem['description']); ?>
                   </div>
                   ...
                   <div class="form-group">
                        <label> Catégorie : </label><?php echo utf8_encode('   '. $rowItem['categoryName']); ?>
                   </div>
            ...
            <div class="col-sm-6 site">
              ...
              <div class="thumbnail">
                ...
                <div class="caption">
                  <h4><?php echo utf8_encode('   '. $rowItem['name']); ?></h4>
                  <p><?php echo utf8_encode('   '. $rowItem['description']); ?></p>
                </div>
              </div>
            </div>
